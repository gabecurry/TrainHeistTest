...
const suspects = [
  {
    name: "Jesse 'Quick-Draw' Colt",
    backstory: `
      Jesse is a notorious gunslinger who once rode with the infamous Dust Devils gang. 
      Known for his lightning-fast draw and steady hand, Jesse left the gang after a bitter fallout. 
  ...
  {
    name: "Clara 'Locks' McGraw",
    backstory: `
      Clara, a former saloon girl turned safecracker, has a knack for breaking into the toughest vaults. 
      Her charm is rivaled only by her cunning, but Clara’s known to hold grudges. 
  ...
  {
    name: "Hank 'The Bull' Turner",
    backstory: `
      A burly ranch hand with a quick temper, Hank was recently fired from the governor's estate. 
  ...
  {
    name: "Annabelle 'The Widow' Cartwright",
    backstory: `
      A mysterious widow who travels frequently, Annabelle is always dressed in mourning black. 
  ...
  {
    name: "Eli 'The Drifter' McCoy",
    backstory: `
      A wandering prospector with a history of train hopping, Eli has been in and out of trouble for years. 
  ...
  {
    name: "Pearl 'The Ace' Donovan",
    backstory: `
      A card shark with a reputation for winning and disappearing just as quickly, Pearl has been banned from every major saloon in the West. 
  ...
  {
    name: "Silas 'The Preacher' Boone",
    backstory: `
      A former preacher turned wandering storyteller, Silas claims to be on a mission to spread good morals. 
  ...
  {
    name: "Ruby 'The Fox' Sinclair",
    backstory: `
      A former showgirl with a knack for deception, Ruby uses her beauty and wit to outsmart her foes. 
    ...
    clues: [
      ...
      "A discarded train ticket for an earlier destination was found crumpled under a seat.",
